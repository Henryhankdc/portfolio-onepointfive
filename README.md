Starter Environment
---
*[Based off a starter environment from Una Kravets](https://github.com/una/gulp-starter-env)* 
*Ongoing additions made by [me](https://github.com/Henryhankdc), but all credit and thanks for this foundation goes to [Una Kravets](https://github.com/una)* 
...
2. Clone this repo with `git clone https://github.com/henryhankdc/gulp-starter-env <your-project-name>` to build this repo into your own project or download the zip
